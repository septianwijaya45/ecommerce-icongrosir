(function ($) {
    ...
    $.fn.simpleGallery = function (options) {
        ...
        var init = function () {
            ...
            // Cek apakah file adalah video (berdasarkan ekstensi .mp4)
            if (src.endsWith('.mp4')) {
                var video = $('<video>', {
                    controls: true,
                    autoplay: true,
                ...
                video.attr('src', src);
                video.appendTo(image_container); // Masukkan video ke dalam kontainer
            } else {
                // Jika bukan video, tampilkan gambar
