            ...
            <div class="aa-product-area">
                ...
                <!-- start prduct navigation -->
                    ...
                    <div class="tab-pane fade in active" id="men">
                        ...
                        <li>
                            <figure>
                            <a class="aa-product-img" href="#"><img src="img/products/polo/polo1.jpeg" width="250px" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                                <figcaption>
                                <h4 class="aa-product-title"><a href="#">Polo T-Shirt</a></h4>
                                <span class="aa-product-price">Rp 500k / 50 Kaos</span><span class="aa-product-price"><del>Rp 1 Juta</del></span>
                            </figcaption>
                            </figure>                        
                        ...
                        <li>
                            <figure>
                            <a class="aa-product-img" href="#"><img src="img/products/kaos2.png" width="250px" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                                <figcaption>
                                <h4 class="aa-product-title"><a href="#">T-Shirt</a></h4>
                                <span class="aa-product-price">Rp 500k / 50 Kaos</span>
                            </figcaption>
                            </figure>                         
                            <div class="aa-product-hvr-content">
                            <a href="#" data-toggle="tooltip" data-placement="top" title="Add to Wishlist"><span class="fa fa-heart-o"></span></a>
                        ...
                        <li>
                            <figure>
                            <a class="aa-product-img" href="#"><img src="img/products/polo/polo2.avif" width="250px" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                                <figcaption>
                                <h4 class="aa-product-title"><a href="#">Polo T-Shirt</a></h4>
                                <span class="aa-product-price">Rp 500k / 50 Kaos</span><span class="aa-product-price"><del>Rp 1 Juta</del></span>
                        ...
                        <li>
                            <figure>
                            <a class="aa-product-img" href="#"><img src="img/products/polo/polo3.jpg" width="180px" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                                <h4 class="aa-product-title"><a href="#">Polo T-Shirt</a></h4>
                                <span class="aa-product-price">Rp 500k / 50 Kaos</span><span class="aa-product-price"><del>Rp 1 Juta</del></span>
                        ...
                        <li>
                            <figure>
                            <a class="aa-product-img" href="#"><img src="img/products/kaos1.png" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                                <h4 class="aa-product-title"><a href="#">T-Shirt</a></h4>
                                <span class="aa-product-price">Rp 500k / 50 Kaos</span>
                        ...
                        <li>
                            <figure>
                            <a class="aa-product-img" href="#"><img src="img/products/polo/polo4.jpg" width="200px" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                                <h4 class="aa-product-title"><a href="#">Polo T-Shirt</a></h4>
                                <span class="aa-product-price">Rp 500k / 50 Kaos</span><span class="aa-product-price"><del>Rp 1 Juta</del></span>
                        ...
                        <li>
                            <figure>
                            <a class="aa-product-img" href="#"><img src="img/products/polo/polo5.jpg" width="180px" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                                <h4 class="aa-product-title"><a href="#">Polo T-Shirt</a></h4>
                                <span class="aa-product-price">Rp 500k / 50 Kaos</span><span class="aa-product-price"><del>Rp 1 Juta</del></span>
                        ...
                        <li>
                            <figure>
                            <a class="aa-product-img" href="#"><img src="img/products/kaos3.png" width="250px" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                                <h4 class="aa-product-title"><a href="#">T-Shirt</a></h4>
                                <span class="aa-product-price">Rp 500k / 50 Kaos</span>
