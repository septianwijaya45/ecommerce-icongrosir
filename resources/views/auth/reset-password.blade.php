           ...
           <div class="row">
             <div class="col-md-12">
               <div class="aa-myaccount-register">
                ...
                <form action="{{ route('change.password', $token_reset) }}" method="POST" class="aa-login-form">
                    @csrf
                   ...
                   <button type="submit" class="aa-browse-btn" id="submit-btn">Reset Passwordku</button>
                 </form>
               </div>
             </div>
           </div>
